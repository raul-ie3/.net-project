...
namespace howto_password_tracker
{
    public partial class Form1 : Form
    {
        ...
        private void LoadSettings()
        {
            ...
            for (int i = 0; ; i++)
            {
                // Get the next password's name and value.
                ...
                // Decrypt the name, password, and date.
                ...
                // Display the result.
                dgvPasswords.Rows.Add(new Object[] {plain_name, plain_value, plain_date, null, null});
            }
        ...
        private void SaveSettings()
        {
            ...
            foreach (DataGridViewRow row in dgvPasswords.Rows)
            {
                ...
                if ((plain_name.Length == 0) || (plain_value.Length == 0) || (plain_date.Length == 0))
                {
